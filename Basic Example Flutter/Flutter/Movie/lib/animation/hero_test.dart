    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Row(
          ...
          children: [
            _buildHero(context, 'lib/resources/images/image_test.png', 'Chair'),
            _buildHero(
                context, 'lib/resources/images/image_test_1.png', 'Binoculars'),
            _buildHero(
                context, 'lib/resources/images/image_test_2.png', 'Beach ball'),
          ],
        ),
      ),
    );
